...
import { MapPin, Smartphone, Zap, Star, ArrowRight } from 'lucide-react';
    ...
    <section className="relative py-12 md:py-20 bg-richblack overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 bg-gold-500/10 border border-gold-500/20 rounded-full px-3 py-1.5">
            ...
            <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-gold-500/10 border border-gold-500/20 flex items-center justify-center text-gold-500 group-hover:scale-110 transition-transform">
                    <Smartphone size={20} />
                  </div>
                  <div>
                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-tight leading-none">
                      Consultoria Online
                    </h3>
                    <div className="flex items-center gap-1 mt-1">
                       <Zap size={10} className="text-gold-500" />
                       <span className="text-[10px] text-gold-500 font-bold uppercase">Metodologia Validada</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <p className="text-neutral-400 text-xs md:text-sm leading-relaxed mb-4 grow">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                       ...
                       <span className="text-[10px] text-gold-500 font-bold uppercase">Experiência VIP</span>
                    </div>
                  </div>
                </div>
              </div>
