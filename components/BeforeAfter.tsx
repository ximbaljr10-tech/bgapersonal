...
import { ChevronRight, GripVertical, Layers, Hand } from 'lucide-react';
...
      
          {/* CONTROLES - BLOCO MODIFICADO AQUI */}
          <div className="mt-6 flex items-center justify-between w-full gap-4">
            {/* NOVO BLOCO: Prova Social/Contagem */}
            <div className="flex-1 flex items-center gap-3 bg-neutral-900 border border-gold-500/30 px-4 h-14 rounded-lg overflow-hidden">
              <Layers className="text-gold-500 w-6 h-6 shrink-0" />
              <div className="flex flex-col justify-center overflow-hidden">
                <span className="text-[10px] text-gold-500 uppercase font-bold tracking-wider leading-tight">Resultados</span>
                <span className="text-white font-black text-sm leading-tight truncate">
                  REAIS <span className="text-neutral-500 font-bold ml-1">({activeCase + 1}/{cases.length})</span>
                </span>
              </div>
            </div>
...
                {isLoading ? 'Carregando...' : 'VER PRÓXIMO RESULTADO'}
                {!isLoading && (
